...
hist(as.vector(distrib_trait$mean)[which(as.vector(distrib_trait$mean) != 0)], main = "SD distribution", xlab = "SD")
hist(as.vector(distrib_trait$sd)[which(as.vector(distrib_trait$sd) != 0)], main = "Mean distribution", xlab = "Mean")
