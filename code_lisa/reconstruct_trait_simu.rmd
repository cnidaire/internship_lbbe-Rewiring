...
fig1 <- ggplot(gather(param_tr1ax1), aes(x = key, y = value)) + 
  geom_boxplot() + 
  ggtitle("Trait 1 Axis 1") +
  ylab("Correlation") +
  xlab("Mean env tolerance") +
  theme_bw()
fig2 <- ggplot(gather(param_tr2ax2), aes(x = key, y = value)) + 
  geom_boxplot() + 
...
ggsave(file = "env.svg", plot = ggarrange(fig1, fig2), width = 12, height = 8)
```
...
ggarrange(fig1, fig2)
ggsave(file = "ninter.svg", plot = ggarrange(fig1, fig2), width = 12, height = 8)
```
...
fig1 <- ggplot(gather(param_tr1ax1), aes(x = key, y = value)) + 
  ...
  ggtitle("Trait 1 Axis 1") +
  ylab("Correlation") +
  xlab("Number of locations sampled") +
  theme_bw()
fig2 <- ggplot(gather(param_tr2ax2), aes(x = key, y = value)) + 
  geom_boxplot() + 
  ggtitle("Trait 2 Axis 2") +
...
ggsave(file = "frame.svg", plot = ggarrange(fig1, fig2), width = 12, height = 8)
```
...
fig1 <- ggplot(gather(param_tr1ax1), aes(x = key, y = value)) + 
  ...
  ggtitle("Trait 1 Axis 1") +
  ylab("Correlation") +
  xlab("Weight to trait matching (delta)") +
  theme_bw()
fig2 <- ggplot(gather(param_tr2ax2), aes(x = key, y = value)) + 
  geom_boxplot() + 
  ggtitle("Trait 2 Axis 2") +
...
ggsave(file = "delta.svg", plot = ggarrange(fig1, fig2), width = 12, height = 8)
```
...
fig1 <- ggplot(gather(param_tr1ax1), aes(x = key, y = value)) + 
  ...
  ggtitle("Trait 1 Axis 1") +
  ylab("Correlation") +
  xlab("Ratio between trait 1 and 2") +
  theme_bw()
fig2 <- ggplot(gather(param_tr2ax2), aes(x = key, y = value)) + 
  geom_boxplot() + 
  ggtitle("Trait 2 Axis 2") +
...
ggsave(file = "grad.svg", plot = ggarrange(fig1, fig2), width = 12, height = 8)
```
...
ggsave(file = "trait.svg", plot = ggarrange(fig1, fig2), width = 12, height = 8)
```
