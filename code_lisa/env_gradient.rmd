...
```{r}
test_1 <- env_grad_netw(nb_resource =10 , nb_consumer = 10, nb_location = 10)
test_1[[1]]
```
...
for (i in 1:10) {
  ...
  theme(axis.text = element_blank(),
        ...
        axis.line.x.top = element_line(colour = "darkred", 
                                       size = 3),
        axis.line.y = element_line(colour = "cornflowerblue", 
                                   size = 3))
  dev.off()
}
