...
row_abund -\> abund_resource

col_abund -\> abund_consumer
...
-   Créer gradient environement

-   générer abondances

-   Créer matrice matching

    -   soit utiliser fonction pour juste faire le produit de matrices mais ça fait beaucoup de modifs pour quasi rien
...
delta = 1
  ...
  prop_row <- abund_resource[1,]/sum(abund_resource[1,]) # Get the proportion of each plant (its "availability")
  ab_neutral <- prop_row %*% t(abund_consumer[1,]) # Get the predicted abundance -> the birds
